        ...
        <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4">
          <ul class="mb-0 list-unstyled d-flex justify-content-between">
            ...
            <li class=" " aria-current="page">
              <a href="../TechnicienPage.php">page acuill</a>
              <?php 
      ...
      <div class="d-flex justify-content-center gap-2">
        <div class="card mb-4 col-5">
          ...
          <div class="head-title">
            <a href="TelchargerTECPDF.php?ref=<?=$data['idgestionT']?>" class="btn-download">
...
<form action="" class="send_message" method="post" id="formMessage">
  <textarea class="form-control" name="message" id="" cols="30" rows="2" placeholder="entre votre message"></textarea>
...
if(isset($_POST['Send'])){
  if(!empty($_POST['message'])){
    ...
    $env=$stmt->execute([":idGestion"=>$id_gestion,":idUser"=>$id_user,":descriptions"=>$_POST['message']]);
        ...
        echo '<div class=" container  text-center alert alert-danger" id="success-alert">
        le champs sont obligatoires!
        <span style="float: right;font-weight: bold;">X</span>
        </div>';
      }
}
?>
...
<?php  
    ...
    ?>
        ...
        <div><a href="Technecien.php" class="btn btn-primary">page accuill</a></div>
      <?php 
         }
} else {
?>
...
?> 
 ...
 $(function(){
     $('#loader').load('DetailsTechnicien/<?=$id_gestion?>')
   })
